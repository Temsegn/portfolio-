...
export default function Footer() {
  ...
  const socialLinks = [
    { icon: Github, href: "https://github.com/Temsegn", label: "GitHub" },
    { icon: Linkedin, href: "#", label: "LinkedIn" },
    { icon: Twitter, href: "https://x.com/mom_love_4", label: "Twitter" },
    { icon: Mail, href: "mailto:tommr2323@gmail.com", label: "Email" },
  ]
