...
export default function Projects() {
  ...
  const projects = [
    // BACKEND SECTION - 7 APIs
    {
      ...
      githubUrl: "https://github.com/Temsegn/Flutter-Job-App",
      liveUrl: "#",
      featured: true,
     ...
     
    {
      ...
      category: "Backend",
      technologies: ["Express", "Node.js", "MongoDB", "REST API", "Cloudinary", "JWT", "Socket.io", "Auth0"],
      githubUrl: "https://github.com/Temsegn/Ecommerce-API",
      liveUrl: "#",
      featured: true,
      complexity: "Enterprise",
      features: [
    ...
    },
    {
      ...
      category: "Backend",
      technologies: ["Express", "Node.js", "MongoDB", "REST API", "Cloudinary", "JWT", "Socket.io", "Auth0"],
      githubUrl: "https://github.com/Temsegn/Advanced-Auth",
      liveUrl: "#",
      featured: false,
      complexity: "Enterprise",
      features: [
    ...
    },
    {
      ...
      category: "Backend",
      technologies: ["Express", "Node.js", "MongoDB", "REST API", "Cloudinary", "JWT", "Socket.io", "Auth0"],
      githubUrl: "https://github.com/Temsegn/Task-Management-api-",
      liveUrl: "#",
      featured: false,
      complexity: "Advanced",
      features: [
    ...
    },
    {
      ...
      category: "Backend",
      technologies: ["Express", "Node.js", "MongoDB", "REST API", "Cloudinary", "JWT", "Socket.io", "Auth0"],
      githubUrl: "https://github.com/Temsegn/Wisdom-Walk-App",
      liveUrl: "#",
      featured: true,
      complexity: "Advanced",
      features: [
    ...
    },
    {
      ...
      category: "Backend",
      technologies: ["Express", "Node.js", "MongoDB", "REST API", "Cloudinary", "JWT", "Socket.io", "Auth0"],
      githubUrl: "https://github.com/Temsegn/The-Book-validator-",
      liveUrl: "#",
      featured: false,
      complexity: "Advanced",
      features: [
    ...
    // FULL STACK SECTION - 1 Project
    {
      ...
      githubUrl: "https://github.com/Temsegn/equilex-final-year-project",
    ...
    // MOBILE SECTION - 5 Apps
    {
      ...
      githubUrl: "https://github.com/Temsegn/Finance_tracker",
      liveUrl: "#",
      featured: true,
      complexity: "Advanced",
      features: [
    ...
    {
      id: 10,
      title: "Wisdomwalk women Community App",
        description:
        "Community platform backend for women's experience sharing and religious discussions with moderated content, prayer requests, and spiritual guidance.",
      longDescription:
        "An empowering platform backend creating safe spaces for women to share experiences, seek guidance, and engage in meaningful religious discussions with community support.",
