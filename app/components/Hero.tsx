          ...
          >
            ...
            >
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-2 border-gray-300 bg-orange-500 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 px-6 lg:px-8 py-3 lg:py-4 text-base lg:text-lg transition-all duration-300 group bg-transparent"
              >
                 Hire Me
              </Button>
            </motion.div>
            ...
            >
              {[
                { icon: Github, href: "https://github.com/Temsegn", label: "GitHub", color: "hover:bg-gray-100 dark:hover:bg-gray-800" },
                { icon: Linkedin, href: "#", label: "LinkedIn", color: "hover:bg-blue-50 dark:hover:bg-blue-900/20" },
                { icon: Mail, href: "mailto:tommr2323@gmail.com", label: "Email", color: "hover:bg-red-50 dark:hover:bg-red-900/20" },
                {
                  icon: ExternalLink,
                  href: "#",
                  label: "Portfolio",
